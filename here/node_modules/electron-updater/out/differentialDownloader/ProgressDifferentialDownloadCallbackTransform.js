...
class ProgressDifferentialDownloadCallbackTransform extends _stream().Transform {
  ...
  _transform(chunk, encoding, callback) {
    ...
    if (now >= this.nextUpdate && this.transferred !== this.expectedBytes
    /* will be emitted by endRangeDownload() */
