...
function _ProgressDifferentialDownloadCallbackTransform() {
  const data = require("./ProgressDifferentialDownloadCallbackTransform");

  _ProgressDifferentialDownloadCallbackTransform = function () {
    return data;
  };
...
class DifferentialDownloader {
  ...
  async doDownloadFile(tasks, fdList) {
    ...
    await new Promise((resolve, reject) => {
      const streams = []; // Create our download info transformer if we have one
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        downloadInfoTransform = new (_ProgressDifferentialDownloadCallbackTransform().ProgressDifferentialDownloadCallbackTransform)(progressDifferentialDownloadInfo, this.options.cancellationToken, this.options.onProgress);
